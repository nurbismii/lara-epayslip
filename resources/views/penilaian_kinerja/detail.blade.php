                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td rowspan="5">2. Etika Kerja dan Dedikasi Kerja</td>
                                    ...
                                    <tr>
                                        <td rowspan="5">3. Kedisiplinan</td>
                                    ...
                                    <tr>
                                        ...
                                        <td rowspan="5">1. Pengetahuan Profesi</td></td>
                                    ...
                                    <tr>
                                        <td rowspan="5">2. Kemampuan Pemahaman Dalam Bekerja
                                        </td>
                                        <td>Hanya mengerjakan pekerjaan rutin yang dilakukan setiap hari.</td>
                                        <td>@if($data->pemahaman_dalam_bekerja == 39) &#10004; @endif</td>
                                        <td rowspan="5"> {{ $data->pemahaman_dalam_bekerja }} </td>
                                    </tr>
                                    <tr>
                                        <td>Tidak mau mengerjakan pekerjaan diluar dari job desc dan jam kerja.</td>
                                    ...
                                    <tr>
                                        <td>Mengerti arahan serta prosedur juga memberikan ilmu kepada rekan kerja.</td>
                                    ...
                                    <tr>
                                        <td rowspan="5">3. Kemampuan Pengambilan Keputusan</td>
                                        <td>Mengambil keputusan dengan spontan ketika terjadi masalah tanpa menganalisa risiko terlebih dahulu.</td>
                                    ...
                                    <tr>
                                        <td>Mengambil keputusan berdasarkan emosi yang terkadang kurang objektif.</td>
                                        <td>@if($data->pengambilan_keputusan == 14) &#10004; @endif </td>
                                    </tr>
                                    <tr>
                                        <td>Hanya menunggu keputusan dari atasan ketika terjadi masalah.</td>
                                        <td>@if($data->pengambilan_keputusan == 6) &#10004; @endif </td>
                                    </tr>
                                    <tr>
                                        <td>Memahami serta menganalisa situasi dan kondisi ketika terjadi masalah.</td>
                                        <td>@if($data->pengambilan_keputusan == 15) &#10004; @endif </td>
                                    </tr>
                                    <tr>
                                        <td rowspan="20">III. Kemampuan Menyelesaikan Pekerjaan</td>
                                        <td rowspan="5">1. Efisiensi Kerja</td>
                                        <td>Menyelesaikan pekerjaan sesuai target waktu serta target kerja terpenuhi.</td>
                                        <td>@if($data->efesiensi_kerja == 58) &#10004; @endif </td>
                                        <td rowspan="5"> {{ $data->efesiensi_kerja }} </td>
                                    </tr>
                                    <tr>
                                        <td>Ketepatan waktu penyelesaian pekerjaan kurang namun mampu mencapai target kerja.</td>
                                        <td>@if($data->efesiensi_kerja == 50) &#10004; @endif </td>
                                    </tr>
                                    <tr>
                                        <td>Tidak mampu dalam mencapai target kerja serta tidak memiliki rencana kerja.</td>
                                    ...
                                    <tr>
                                        <td rowspan="5">2. Pengendalian diri dalam bekerja </td>
                                    ...
                                    <tr>
                                        <td rowspan="5">3. Kualitas Kerja</td>
                                    ...
                                    <tr>
                                        <td>Kualitas kerja bagus juga menjadi panutan dalam tim dan lingkungan.</td>
                                        <td>@if($data->kualitas_kerja == 49) &#10004; @endif</td>
                                    </tr>
                                    <tr>
                                        <td>Kualitas kerja kurang bagus terkadang terdapat revisi atau pengulangan kerja.</td>
                                    ...
                                    <tr>
                                        <td rowspan="5">4. Kesadaran Keselamatan Dalam Berkerja</td>
                                        <td>Tidak acuh pada keselematan kerja namun mengenakan APD pada saat bekerja.</td>
                                    ...
                                    <tr>
                                        <td>Menggunakan APD saat bekerja juga mampu memberikan pemahaman kepada rekan kerja terkait pentingnya keselamatan.</td>
                                        <td>@if($data->keselamatan_dalam_kerja == 35) &#10004; @endif </td>
                                    </tr>
                                    <tr>
                                        <td>Tidak mengabaikan keselamatan kerja dan selalu patuh terkait penggunaan APD lengkap saat bekerja.</td>
                                        <td>@if($data->keselamatan_dalam_kerja == 22.5) &#10004; @endif </td>
                                    </tr>
                                    <tr>
                                        <td>Memiliki kesadaran akan keselamatan kerja dan mengetahui aturan dalam penggunaan APD lengkap saat bekerja.</td>
