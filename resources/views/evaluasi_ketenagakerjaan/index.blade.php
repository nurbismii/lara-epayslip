                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Evaluasi Ketenagakerjaan</li>
                        </ol>
                    </div>
                    <h4 class="page-title">Evaluasi Ketenagakerjaan</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                        <form action="{{ route('evaluasi-ketangakerjaan.store') }}" method="post" enctype="multipart/form-data">
                            @csrf

                                 <div class="form-example-wrap mg-t-30">
                                     <div class="cmp-tb-hd cmp-int-hd">
                                         <h5>Upload Evaluasi Ketenagakerjaan</h5>
                                     </div>
                        ...
                        <table id="state-saving-datatable" class="table dt-responsive nowrap w-100">
                            <thead>
                                <tr>
                                    <th>Nik</th>
                                    <th>Total Nilai</th>
                                    <th>Nilai Terkonversi</th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach ($data as $d)
                                <tr>
                                    <td><a href="{{ route('evaluasi-ketangakerjaan.show', $d->id) }}" target="_blank">{{ $d->data_karyawan->nik }}</a></td>
                                    <td>{{ $d->total_nilai }}</td>
                                    <td>{{ number_format($d->nilai_terkonversi,2,'.','') }}</td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
