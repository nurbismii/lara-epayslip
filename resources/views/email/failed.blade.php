...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Pay Slip | Konfirmasi Gagal </title>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center">
                                    <h3 class="mt-4">KONFIRMASI GAGAL </h3>
                                    <p class="text-muted mb-0">Maaf, kode token anda tidak dapat ditemukan di sistem kami, pastikan url yang
                                        kami berikan di email sudah benar . Terimakasih
                                    </p>
                                </div>
