            ...
            if ($sheet->getIndex() === 0) {
                ...
                foreach ($sheet->getRowIterator() as $row) {
                    ...
                    if ($no > 0) {
                        ...
                        $etika_kerja_dedikasi_kerja = $cells[3];
                        $kedisiplinan = $cells[4];
                        $pengetahuan_profesi = $cells[5];
                        $kemampuan_pemahaman_dalam_bekerja = $cells[6];
                        $kemampuan_pengambilan_keputusan = $cells[7];
                        $efisiensi_kerja = $cells[8];
                        $pengendalian_diri_dalam_bekerja = $cells[9];
                        $kualitas_kerja = $cells[10];
